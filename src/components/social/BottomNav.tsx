  ...
  return (
    ...
    >
      <motion.nav
        ...
        className="glass-panel pointer-events-auto flex h-16 w-[90%] max-w-md items-center justify-around rounded-full border border-white/10 px-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
      >
