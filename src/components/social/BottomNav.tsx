    ...
    >
      <motion.nav
        ...
        className={cn(
          "pointer-events-auto",
          isHome
            ? "glass-panel flex h-16 w-[90%] max-w-md items-center justify-around rounded-full border border-white/10 px-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
            : "mx-auto w-full max-w-[25.5rem] rounded-[1.75rem] border border-white/8 bg-background/88 px-2 py-2 shadow-[0_26px_80px_-40px_rgba(0,0,0,1)] backdrop-blur-2xl",
        )}
      >
        {isHome ? (
